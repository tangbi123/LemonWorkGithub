...
namespace Lemon.bossControl
{
    public class CharacterControllerHj : MonoBehaviour
    {
        ...
        {
            bool temp = ((m_CurrentStateInfo.tagHash == m_HashBlockWalk) && (!m_IsAnimatorTransitioning));
            bool attack = (temp | (m_NextStateInfo.tagHash == m_HashBlockWalk));
            return attack;
        }
